...
#
# check_yolo_setup()
# yolo_model = initialize_yolo("yolov8n.pt")
# results = detect_and_crop_objects(yolo_model, "https://i.pinimg.com/564x/78/19/e8/7819e8797424eb54391a3cc2f4ec7853.jpg")
# features_dict = extract_features_from_cropped_images()
# catalog_features = extract_features_from_catalog_images("/Users/manya./PycharmProjects/Model/BaseSimilarityModel/catalog")
# recommendations = generate_recommendations(features_dict, catalog_features)
# display_recommendations(recommendations, 'cropped_images', '/Users/manya./PycharmProjects/Model/BaseSimilarityModel/catalog')
# "'"
#
